...
const AdminCompliance = () => {
  ...
  const userData = {
    name: 'Rajesh Kumar (राजेश कुमार) - Compliance Officer',
    email: 'rajesh@agritrace.in',
    role: 'admin',
    avatar: null
  };
  ...
  const notifications = [
    {
      id: 1,
      type: 'warning',
      message: '5 compliance violations require immediate attention (तुरंत ध्यान आवश्यक)',
    ...
    },
    {
      id: 2,
      type: 'info',
      message: 'Monthly compliance report generated for Indian markets (मासिक रिपोर्ट तैयार)',
  ...
  const mockComplianceData = [
    {
      id: 'COMP-001',
      type: 'certification',
      title: 'FSSAI Organic Certification Expiring (जैविक प्रमाणपत्र समाप्ति)',
      description: 'Shree Krishna Farm organic certification expires in 30 days',
      entity: 'Shree Krishna Farm (श्री कृष्ण फार्म)',
      entityType: 'farmer',
      severity: 'medium',
      status: 'pending',
      dueDate: '2024-02-15T00:00:00Z',
      createdDate: '2024-01-15T10:30:00Z',
      assignedTo: 'Priya Sharma (प्रिया शर्मा)',
      category: 'Food Safety (खाद्य सुरक्षा)',
    ...
    },
    {
      id: 'COMP-002',
      type: 'violation',
      title: 'Temperature Log Discrepancy (तापमान लॉग विसंगति)',
      description: 'Bharti Logistics shipment SH-2024-001 shows temperature deviation during Mumbai-Delhi route',
      entity: 'Bharti Logistics Solutions (भारती लॉजिस्टिक्स)',
      entityType: 'distributor',
      severity: 'high',
      status: 'investigating',
      dueDate: '2024-01-18T00:00:00Z',
      createdDate: '2024-01-15T08:45:00Z',
      assignedTo: 'Vikram Singh (विक्रम सिंह)',
      category: 'Cold Chain (शीत शृंखला)',
      regulatoryBody: 'FSSAI',
    ...
    },
    {
      id: 'COMP-003',
      type: 'audit',
      title: 'Quarterly Food Safety Audit (त्रैमासिक खाद्य सुरक्षा ऑडिट)',
      description: 'Scheduled audit for Reliance Fresh retail operations in Mumbai',
      entity: 'Reliance Fresh (रिलायंस फ्रेश)',
      entityType: 'retailer',
      severity: 'low',
      status: 'scheduled',
      dueDate: '2024-01-25T00:00:00Z',
      createdDate: '2024-01-10T14:20:00Z',
      assignedTo: 'Anita Desai (अनिता देसाई)',
      category: 'Food Safety (खाद्य सुरक्षा)',
      regulatoryBody: 'Mumbai Municipal Corporation',
      actions: ['Site Inspection', 'Documentation Review']
    },
    {
      id: 'COMP-004',
      type: 'documentation',
      title: 'Missing Traceability Records (अनुपस्थित प्रलेखन)',
      description: 'Sahyadri Farms missing batch tracking documentation for organic produce',
      entity: 'Sahyadri Farms (सह्याद्रि फार्म्स)',
      entityType: 'farmer',
      severity: 'medium',
      status: 'overdue',
      dueDate: '2024-01-12T00:00:00Z',
      createdDate: '2024-01-05T09:15:00Z',
      assignedTo: 'Suresh Patil (सुरेश पाटिल)',
      category: 'Traceability (प्रलेखन)',
      regulatoryBody: 'Maharashtra Agriculture Department',
      actions: ['Document Submission', 'Process Review']
    },
    {
      id: 'COMP-005',
      type: 'certification',
      title: 'HACCP Certification Renewal (प्रमाणपत्र नवीनीकरण)',
      description: 'Amul Dairy HACCP certification renewal approved for Gujarat facility',
      entity: 'Amul Dairy (अमूल डेयरी)',
      entityType: 'farmer',
      severity: 'low',
      status: 'resolved',
      dueDate: '2024-01-10T00:00:00Z',
      createdDate: '2023-12-15T11:30:00Z',
      assignedTo: 'Kavita Patel (कविता पटेल)',
      category: 'Food Safety (खाद्य सुरक्षा)',
      regulatoryBody: 'FSSAI',
